...
class BaseTradingBotOneInstrument(BaseTradingBot):
    def __init__(self,
        ...
        self.limit_order_side = OrderSides.ORDER_SIDE_BUY if self.grid_direction == GRID_DIRECTION_LONG else OrderSides.ORDER_SIDE_SELL
        self.take_profit_side = OrderSides.ORDER_SIDE_SELL if self.grid_direction == GRID_DIRECTION_LONG else OrderSides.ORDER_SIDE_BUY
